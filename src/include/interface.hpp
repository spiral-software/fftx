...
public:
  ...
  /** Array of length 3 that contains the following.
      ...
      The manner of specifying the pointer in each element of <tt>args</tt> depends on the type, T, and the backend:
      ...
      - for CPU, specify <tt>(void*) ptr</tt> with T* <tt>ptr</tt>.
  */
