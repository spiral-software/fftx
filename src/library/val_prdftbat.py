...
def setup_input_array ( array_shape, fwd ):
    """
    Create an input array based on the array shape tuple.

    Parameters:
      - array_shape: Tuple specifying the shape of the array.
      - fwd: Boolean indicating whether it's a forward transform (True) or inverse transform (False).
