...
int main(int argc, char *argv[]) {
    ...
    cufftCreate(&plan);
    cufftPlanMany(&plan, fft.size(), fft.data(), nullptr, 1,
    ...
    hipMemcpyHtoD(d_data, data.data(), sizeof(data_type) * data.size());
    ...
    hipMemcpyDtoH(data.data(), d_data, sizeof(data_type) * data.size());
