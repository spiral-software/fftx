    ...
    #ifndef imddft_CODEGEN_H
    #define imddft_CODEGEN_H

    #include "fftx3.hpp"

    extern void init_imddft_spiral(); 
    extern void imddft_spiral(double* Y, double* X, double* symvar); 
    extern void destroy_imddft_spiral();
   ...
   namespace imddft
   {
    ...
    {   // for the moment, the function signature is hard-coded.  trace will
      // generate this in our better world
        ...
        std::chrono::high_resolution_clock::time_point t1 = std::chrono::high_resolution_clock::now();
           imddft_spiral(output, input, sym);
        kernelStop();
    ...
    //inline void destroy(){ destroy_imddft_spiral();}
    inline void destroy(){ }
  };
