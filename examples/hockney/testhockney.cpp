...
#else
  fftx::array_t<3, double>& G = GHost;
  fftx::array_t<3, std::complex<double>>& GhatComplex = GhatComplexHost;
#endif
...
#else
  fftx::array_t<3,double>& input = inputHost;
  fftx::array_t<3,double>& output = outputHost;
#endif
