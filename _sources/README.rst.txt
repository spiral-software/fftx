...
a CPU or a GPU (either CUDA or HIP) depending on the platform specified
with the script. By default, only a small number of fixed sizes will be
...
for CPU or AMD HIP as shown above (under Building for Linux).
